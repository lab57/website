    ...
    return <Layout>
        ...
        <MathJax>
            <p>
                ...
                with the typical values of the parameters, {" \\(\\rho = 28, \\sigma=10, \\beta= \\frac{8}{3}\\)"}.
                For these values, the Lorenz system has chaotic solutions, with chaotic orbits around two strange attractors.
                The numerical calculations are done using the fourth order Runge-Kutta method, written in Javascript.
